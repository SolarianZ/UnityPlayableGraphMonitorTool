...
namespace UnityEngine.Pool
{
    ...
    public class ObjectPool<T> : IDisposable/*, IObjectPool<T>*/ where T : class
    {
        ...
        public ObjectPool(Func<T> createFunc, Action<T> actionOnGet = null, Action<T> actionOnRelease =
 null, Action<T> actionOnDestroy = null, bool collectionCheck = true, int defaultCapacity = 10, int maxSize = 10000)
        {
            if (createFunc == null)
